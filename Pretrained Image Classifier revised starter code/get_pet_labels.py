...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
          ...
          # TODO: Remaining Steps: Iterate over remaining real image files, and extract the pet label from the filename, and add as item to results_dic (ex. filename = 'Boston_terrier_02259.jpg' Pet label = 'boston terrier')
